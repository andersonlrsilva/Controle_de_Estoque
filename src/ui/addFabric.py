...
class Ui_AddFabricante(object):
    ...
    def retranslateUi(self, AddFabricante):
        ...
        self.cmbEstado.setItemText(0, QCoreApplication.translate("AddFabricante", u"Acre", None))
        self.cmbEstado.setItemText(1, QCoreApplication.translate("AddFabricante", u"Alagoas", None))
        self.cmbEstado.setItemText(2, QCoreApplication.translate("AddFabricante", u"Amap\u00e1", None))
        self.cmbEstado.setItemText(3, QCoreApplication.translate("AddFabricante", u"Amazonas", None))
        self.cmbEstado.setItemText(4, QCoreApplication.translate("AddFabricante", u"Bahia", None))
        self.cmbEstado.setItemText(5, QCoreApplication.translate("AddFabricante", u"Cear\u00e1", None))
        self.cmbEstado.setItemText(6, QCoreApplication.translate("AddFabricante", u"Distrito Federal", None))
        self.cmbEstado.setItemText(7, QCoreApplication.translate("AddFabricante", u"Esp\u00edrito Santo", None))
        self.cmbEstado.setItemText(8, QCoreApplication.translate("AddFabricante", u"Goi\u00e1s", None))
        self.cmbEstado.setItemText(9, QCoreApplication.translate("AddFabricante", u"Maranh\u00e3o", None))
        self.cmbEstado.setItemText(10, QCoreApplication.translate("AddFabricante", u"Mato Grosso", None))
        self.cmbEstado.setItemText(11, QCoreApplication.translate("AddFabricante", u"Mato Grosso do Sul", None))
        self.cmbEstado.setItemText(12, QCoreApplication.translate("AddFabricante", u"Minas Gerais", None))
        self.cmbEstado.setItemText(13, QCoreApplication.translate("AddFabricante", u"Par\u00e1", None))
        self.cmbEstado.setItemText(14, QCoreApplication.translate("AddFabricante", u"Para\u00edba", None))
        self.cmbEstado.setItemText(15, QCoreApplication.translate("AddFabricante", u"Paran\u00e1", None))
        self.cmbEstado.setItemText(16, QCoreApplication.translate("AddFabricante", u"Pernambuco", None))
        self.cmbEstado.setItemText(17, QCoreApplication.translate("AddFabricante", u"Piau\u00ed", None))
        self.cmbEstado.setItemText(18, QCoreApplication.translate("AddFabricante", u"Rio de Janeiro", None))
        self.cmbEstado.setItemText(19, QCoreApplication.translate("AddFabricante", u"Rio Grande do Norte", None))
        self.cmbEstado.setItemText(20, QCoreApplication.translate("AddFabricante", u"Rio Grande do Sul", None))
        self.cmbEstado.setItemText(21, QCoreApplication.translate("AddFabricante", u"Rond\u00f4nia", None))
        self.cmbEstado.setItemText(22, QCoreApplication.translate("AddFabricante", u"Roraima", None))
        self.cmbEstado.setItemText(23, QCoreApplication.translate("AddFabricante", u"Santa Catarina", None))
        self.cmbEstado.setItemText(24, QCoreApplication.translate("AddFabricante", u"S\u00e3o Paulo", None))
        self.cmbEstado.setItemText(25, QCoreApplication.translate("AddFabricante", u"Sergipe", None))
        self.cmbEstado.setItemText(26, QCoreApplication.translate("AddFabricante", u"Tocantins", None))
